...
# write out
write.csv(biom_all_ak, 'biomass_expanded_ak.csv', row.names = F)
```
...
# write out full series
write.csv((biom_dfo_bc %>% 
  select(-Biomass_SA) %>%
  rbind(biom_ram_bc)), 'biomass_expanded_bc.csv', row.names = F)
```
